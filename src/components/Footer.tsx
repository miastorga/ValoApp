...
export const Footer = () => {
  ...
  return (
    <footer className="footer footer-center p-10 bg-newBlack text-primary-content">
      <div>
        ...
        <p>@Miguel Astorga {currentYear}- All right reserved</p>
      </div>
      <div>
        <div className="grid grid-flow-col gap-4">
          <a href="https://www.linkedin.com/in/mastorga-leiva/">
